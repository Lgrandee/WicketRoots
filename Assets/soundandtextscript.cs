...
public class SoundAndTextScript : MonoBehaviour
{
    ...
    private bool soundPermanentlyStopped = false;
    ...
    private void SpawnBubble()
    {
        ...
        // Permanently stop ambient sound when dialogue starts (player pressed E)
        StopAmbientSound();
        soundPermanentlyStopped = true;
    ...
    {
        if (ambientSound != null && audioSource != null && !soundPermanentlyStopped)
        {
            audioSource.clip = ambientSound;
            audioSource.loop = loopAmbientSound;
